...
class GetMoviesUpcomingUseCase extends UseCaseBase<List<Movie>, NoParams> {
  final HomePageRepositoryBase homeRepository;

  GetMoviesUpcomingUseCase({required this.homeRepository});

  @override
  Future<Either<Failure, List<Movie>>> call(NoParams params) {
    return homeRepository.getMoviesUpcoming(params);
  }
}
